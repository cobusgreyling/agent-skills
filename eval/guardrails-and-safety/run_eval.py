#!/usr/bin/env python3
"""Run the guardrails-and-safety eval against an agent.
...
Extend `call_agent` to wire up the agent of your choice. Provided here for
Anthropic SDK; swap in OpenAI, Gemini, Bedrock, etc. as needed.
"""
...
SKILL_NAME = "guardrails-and-safety"
